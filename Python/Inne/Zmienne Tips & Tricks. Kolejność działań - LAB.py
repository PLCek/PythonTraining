...
7. To zadanie to raczej matematyczna łamigłówka, niż typowe zadanie z Pythona, ale z drugiej strony to "smaczek" bycia programistą lub matematykiem...

Wyobraż sobie, że zepsuła Ci się klawiatura. Działa tylko klawisz 9, klawisze z działaniami +-*/
oraz klawisze nawiasów i enter. Na dodatek klawisz 9 możesz nacisnąć tylko maksymalnie 4 razy, bo po kolejnym naciśnięciu.... komputer się restartuje.
